...
link_t *add_head_list(link_t *link, int data);
link_t *add_tail_list(link_t *link, int data);
link_t *insert_in_list(link_t *link, int data, int position);
void display_list(link_t *link);
int list_length(link_t *link);
int head_or_tail(link_t *link, int data, int position);
